...
const getIconComponent = (iconName: string) => {
  ...
  return (
    iconMap[iconName as keyof typeof iconMap] || DiscordIcon
  );
};
        ...
        <div className="py-12 md:py-16">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12">
            ...
            >
              ...
              {/* Social Links */}
              <div className="flex w-full flex-row items-center justify-center lg:justify-start gap-3 md:gap-4">
                {footerContent.social.map((social, index) => {
                  ...
                  return (
                    <motion.a
                      ...
                      whileTap={{ scale: 0.95 }}
                      className="flex h-5 w-5 md:h-6 md:w-6 shrink-0 opacity-60 hover:opacity-100 transition-opacity duration-200"
            ...
            <div className="lg:col-span-7 mt-8 lg:mt-0">
              <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 gap-6 md:gap-8 lg:gap-12">
                {footerContent.sections.map(
                        ...
                        {section.links.map(
                          (link, linkIndex) => (
                            <li key={linkIndex}>
                              <a
                                href={link.url}
                                className="text-xs md:text-sm text-muted-foreground hover:text-foreground transition-colors duration-200 block"
                              >
                                {link.name}
                              </a>
                            </li>
        ...
        <div className="border-t border-border py-6 md:py-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 md:gap-6 text-center md:text-left">
            ...
            <motion.p
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="text-xs md:text-sm text-muted-foreground order-2 md:order-1"
            >
            ...
            <motion.div
              ...
              className="flex flex-wrap items-center justify-center gap-x-4 md:gap-x-6 gap-y-2 order-1 md:order-2"
            >
